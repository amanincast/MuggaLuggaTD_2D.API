...
{
    /// <inheritdoc />
    public partial class AddTavernState : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TavernStates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TavernStates_GameInstances_GameInstanceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TavernStates_GameInstanceId_UserId",
                table: "TavernStates",
